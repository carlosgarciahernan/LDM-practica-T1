...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista_preguntas[1] = new PreguntaQuiz("¿Cómo se le llama a un grupo de lobos", "Rebaño", "Camada", "Manada", 2);
        ...
        btnNext.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                if(rpst1.isChecked()==true) {
                    if(lista_preguntas[0].getSolucion()==1){
                    ...
                    if(lista_preguntas[0].getSolucion()==2){
                        MostrarToast("Respuesta correcta");
                        puntos++;
                    }else{
                        MostrarToast("Respuesta incorrecta");
                    ...
                    if(lista_preguntas[0].getSolucion()==3){
                        MostrarToast("Respuesta correcta");
                        puntos++;
                    }else{
                        MostrarToast("Respuesta incorrecta");
